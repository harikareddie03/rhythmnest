...
//         })
//         const res = await fetch('http://137.184.81.218:5173/api/playlist/like', {
//             method: "POST",
//             headers: {
...
//                     <img src={masterSong?.img || "/assets/Arijit-1.jpg"} alt="" className="h-12" />
//                     <div>
...
//                         </span>
//                     </div>
//                     <AiOutlineHeart onClick={addToLiked} className="ml-6 cursor-pointer hover:text-green-400" />
...
const SongBar = () => {
    ...
    if (!isLoggedIn) {
        return null; // Hide the SongBar if the user is not logged in
    }
